...
class StereoSetRunner:
    ...
    def __init__(
        ...
        Args:
            ...
            bias_type (`str`): Bias type for self-debiasing. Determines which prompts are given to the model.
        """
...
# # 2. Instantiate the GPT-2 model and tokenizer
# model_name = "gpt2" 
# model = GPT2LMHeadModel.from_pretrained(model_name)
# tokenizer = GPT2Tokenizer.from_pretrained(model_name)
# # print(dir(model))

# # 3. Use the StereoSetRunner class
...
# metric_data = runner() # a nested dict

# import json
# with open('stereoset_result-race.json', 'w') as outfile:
