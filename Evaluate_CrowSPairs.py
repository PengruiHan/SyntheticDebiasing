...
# model_name = "gpt2"  # or just "gpt2" for the smaller model
# tokenizer = GPT2Tokenizer.from_pretrained(model_name)
# model = GPT2LMHeadModel.from_pretrained(model_name)

# # Assuming the class definition you've provided is named `CrowSPairsRunner`
# runner = CrowSPairsRunner(model=model, tokenizer=tokenizer, input_file="crows_pairs_anonymized.csv",bias_type="gender", is_generative=True)
